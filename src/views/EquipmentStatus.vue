  ...
  <div class="equipment-status-page">
    ...
    <header>
      <div class="navbar" :class="{ scrolled: isScrolled }" id="navbar">
        ...
        <div class="nav-right" v-show="!isMobile || menuOpen">
          <div class="nav-item">
          ...
          <div class="nav-item">
            <router-link to="/aborlan-bunker1">ABORLAN BUNKER 1</router-link>
          </div>
          <div class="nav-item">
            <router-link to="/hs-diesel">HS DIESEL PP</router-link>
          </div>
        </div>
      </div>
    </header>
